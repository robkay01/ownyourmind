...
description: "Every prompt you send to OpenAI is training data. Every query to Claude is logged indefinitely. Privacy is not a feature — it is the wedge that makes decentralised AI essential, not just ideological."
