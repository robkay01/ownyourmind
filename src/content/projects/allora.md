...
description: "Self-improving decentralised AI inference network using regret-based model aggregation on Cosmos SDK. Tier-1 exchange listings, $35M raised, zero verified revenue, massive unlock cliff November 2026."
category: "other"
token: "ALLO"
status: "active"
freedomScore: 5
...
returnsScoreEvidence:
  tokenUtility: "Required for inference purchases, topic creation, worker/reputer bonding, staking, governance. PWYW model creates demand uncertainty – consumers can pay zero."
  valueAccrual: "Fees flow to workers/reputers, not passive holders. No burn or buyback. Staking rewards (~12% APY) emission-funded, not revenue-funded. Unproven."
  supplyDynamics: "48.55% of supply cliff unlocks Nov 2026. First 33% tranche (~160M tokens) nearly doubles 220M circulating. FDV/MCap 3.65x. Only 22% circulating."
  revenueSustainability: "No verified revenue. Not on DeFiLlama. PWYW allows zero-fee consumption. 692M inferences self-reported, include testnet. Revenue is a black box."
  liquidityAccess: "Binance, Coinbase, Kraken, OKX, KuCoin, Gate.io, MEXC. $21.8M daily volume. Exceptional exchange coverage for a $25M market cap project."
publishDate: 2025-03-06
draft: false
coingeckoId: "allora"
launchType: "ico"
chain: "Allora L1 (Cosmos SDK / CometBFT)"
supplyType: "capped"
...
Allora Network is a self-improving decentralised AI inference and prediction network. It aggregates competing machine learning models to produce collective intelligence that outperforms any individual model – like a prediction market for AI outputs.

Built on Cosmos SDK with CometBFT consensus, the network is organised around **Topics** – compartmentalised sub-networks targeting specific prediction problems (BTC price prediction, yield optimisation, DeFi risk assessment). Each Topic has four participant types:

- **Workers** generate ML inferences – they deploy models and submit predictions
...
**Pay-What-You-Want (PWYW)** is the fee model. Consumers determine what they pay for inferences. Topics with zero payment receive zero emissions weight, effectively deprioritising them. Consumer contracts are live on Arbitrum One and Sepolia, enabling cross-chain consumption.

The project started as **Upshot** in 2019, focused on NFT appraisal using peer prediction. Founded by **Nick Emmons** (CEO) and **Kenny Peluso** (CTO, BSc Applied Mathematics, Brown University). They recognised broader applications for their peer prediction technology and rebranded to Allora Labs in February 2024. The entity is Allora Labs Inc (formerly Upshot Technologies), registered in the Cayman Islands with operations in New York and Boston. Team of approximately 30 people.

$35 million raised across three rounds: Series A ($7.5M, 2021), Series A Extension ($22M, 2022), and Strategic ($3M, Archetype-led, 2024). Investors include Polychain Capital, Framework Ventures, Blockchain Capital, CoinFund, Delphi Digital, and notable angels Stani Kulechov (Aave), Kain Warwick (Synthetix), and Ryan Selkis (Messari).

Mainnet launched 11 November 2025 alongside TGE, with simultaneous Binance, Coinbase, and Kraken listings – an exceptionally rare achievement for a DeAI project. Token debuted around $1.60 and crashed over 50% on day one.
...
The regret-based Inference Synthesis mechanism is genuinely novel. Unlike Bittensor's subnet model where miners compete for validator approval, Allora's system mathematically weights inferences based on their marginal contribution to prediction accuracy. Models that consistently add unique value are weighted higher. The system is designed to resist Sybil attacks – running the same model twice does not increase rewards because the second copy adds no unique information.
...
Self-reported metrics: 692 million inferences generated, 288,000 workers, 55 active topics. However, these figures include testnet activity and are likely inflated by airdrop farming during the testnet phase. Real mainnet-only metrics are not publicly broken out.

The counter-narrative centres on two critical risks:

**The PWYW model is a structural weakness.** Consumers set their own prices for inferences. If the market converges on paying near-zero fees, the token economy collapses regardless of prediction quality. Topics with zero payment receive zero emissions weight, which theoretically self-corrects – but it also means the network could have many active topics generating inferences with minimal revenue. There is no independently verified revenue data to assess whether real demand exists.

**The vesting cliff is enormous.** 48.55% of total supply (Early Backers 31.05% + Core Contributors 17.50%) begins cliff unlock in November 2026 – eight months away. The first 33% tranche represents approximately 160 million tokens against a current circulating supply of 220 million. This could nearly double the float in a single event. The token is already down 93% from its ATH of $1.70.
...
ALLO has a maximum supply of 1 billion tokens with approximately 220 million circulating (22%). The emission model is disinflationary – Bitcoin-like decreasing emissions over time.
...
- **Core Contributors: 17.50%** – same cliff and vesting as Early Backers. Currently 0% unlocked.
...
- **Allora Prime Staking: 2.50%** – 100% at TGE. Enhanced 9-month staking programme.

The critical event: **November 2026** – Early Backers (31.05%) + Core Contributors (17.50%) = 48.55% of total supply begins unlocking. The first 33% tranche of approximately 160 million tokens would nearly double the current circulating supply of 220 million. Series A investors entered at $60M pre-valuation and the extension at $220M pre-valuation – compared to a current FDV of $93.5M, extension investors are significantly underwater.

No burn mechanism documented. Inference fees flow before new tokens are minted, reducing effective inflation as usage rises. Excess fees accumulate in an Emissions Treasury.

ALLO trades at approximately $0.12 with a market cap around $25.6M and FDV of $93.5M. Daily volume approximately $21.8M – an unusually high volume-to-market-cap ratio driven by the Binance listing. Listed on Binance, Coinbase, Kraken, OKX, KuCoin, Gate.io, and MEXC.
...
**Data Sovereignty: 10/15.** Workers retain ownership of ML models – no uploading of weights required. zkML claims to verify model execution without exposing proprietary weights, though implementation status unclear. Architecture is designed for data sovereignty by default.
...
**Liquidity & Access: 12/15.** Listed on all major exchanges simultaneously at launch: Binance, Coinbase, Kraken, OKX, KuCoin, Gate.io, MEXC. Daily volume of $21.8M is healthy relative to $25.6M market cap. Excellent liquidity for a sub-$100M market cap project. The best exchange coverage of any project at this market cap range.

### Quadrant: B (High Freedom, Low Returns)

Allora sits in Quadrant B/D – technically innovative with genuine decentralisation potential but unproven economics and a looming vesting cliff that could overwhelm the market.
...
- **93% from ATH.** Debuted at $1.70, crashed 50%+ day one, now $0.12. All investors from $220M valuation round deeply underwater.
