---
title: "Cookie DAO"
description: "Centralised AI agent analytics platform with a token. Indexes 1,500+ agents via cookie.fun with Mindshare metric. Zero open source code, no verifiable governance. Strong utility, weak sovereignty."
category: "data"
token: "COOKIE"
status: "active"
freedomScore: 2
...
returnsScoreEvidence:
  tokenUtility: "Premium analytics access (10K COOKIE lock), API gating, MAF airdrop farming, Snaps participation. 5M+ COOKIE locked. Multiple genuine utility vectors but entirely dependent on cookie.fun adoption."
  valueAccrual: "Dual burn: 50% of API fees + 10% of MAF pool locks (170K+ COOKIE daily). Revenue share to stakers. But actual API revenue not disclosed. 97.5% drawdown suggests market scepticism."
  supplyDynamics: "Fixed 1B supply with deflationary burns. 70.5% circulating. Short vesting (1-month cliff + 6-month linear) caused massive unlock pressure in 2024-25. Final unlock June 2028."
  revenueSustainability: "API fees, Snaps campaign fees, trading interface revenue. $5M+ Snaps rewards distributed. No annual revenue disclosed, no DeFiLlama or Token Terminal data. Unproven at scale."
  liquidityAccess: "Binance, Bybit, KuCoin, Coinbase, Kraken, MEXC, Bitget. $17.1M daily volume exceeds market cap. Strong exchange coverage for ~$15M project. Most holders deeply underwater."
...
COOKIE trades at approximately $0.021 with a market cap of ~$14.7M and FDV of $20.8M. Listed on Binance, Bybit, KuCoin, Gate.io, Coinbase, Kraken, MEXC, and Bitget. Daily volume of $17.1M exceeds the market cap, indicating active trading. Public sale investors at $0.025-$0.028 are at -16% to -25% ROI.

## How to participate

**Use cookie.fun.** Free tier available for basic AI agent tracking. Lock 10,000 COOKIE (~$210) for premium analytics including wallet distribution, sentiment analysis, and detailed agent metrics. Technical skill: basic.
...
### Freedom Score: 20/100 (F)

Cookie DAO scores at the bottom of our freedom scale. The "DAO" label is aspirational marketing, not a description of current governance.
...
**Censorship Resistance: 4/15.** cookie.fun is a centralised web application. The team can restrict access, modify data, add or remove agents, and gate features at will. No on-chain data layer exists. The COOKIE ERC-20 token itself is censorship-resistant, but the product is not.
...
**Open Source Transparency: 4/15.** Zero public GitHub repositories. The entire codebase is proprietary. No audit reports found for smart contracts. Token contract is verified on Etherscan but that is table stakes for any ERC-20.

### Returns Score: 52/100 (D)

**Token Utility: 14/20.** COOKIE has multiple genuine use cases: premium analytics access (10K COOKIE lock), API access gating for AI agents, MAF airdrop farming (10-20% of partner rewards), Snaps participation, and governance voting. 5M+ COOKIE locked for premium access demonstrates real demand. However, utility is entirely dependent on cookie.fun platform adoption, and the shift from APY staking to Snaps points reduced predictability.

**Value Accrual: 13/20.** Two mechanical value accrual mechanisms: 50% of API fees burned + 10% of MAF pool locks burned (170K+ COOKIE daily as of July 2025). Revenue share from API fees promised to stakers. However, actual API revenue is not publicly disclosed, making it impossible to verify the real burn impact. The dual burn is structurally sound but unquantified.

**Supply Dynamics: 11/20.** Fixed 1B supply with deflationary burns is positive. 70.5% circulating with final unlock June 2028. The unusually short vesting (1-month cliff + 6-month linear) caused massive unlock pressure in late 2024/early 2025, likely contributing to the 97.5% price decline. Burns provide some deflationary pressure but total rate is not quantified.
...
- **97.5% drawdown.** $0.83 ATH to $0.021. Most holders significantly underwater. Public sale investors at -16% to -25%.
