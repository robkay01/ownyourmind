...
<div class="grid grid-cols-2 md:grid-cols-4 gap-3 not-prose my-6">
  <MetricCard label="Halving Date" value="14 Dec 2025" />
  <MetricCard label="Price at Halving" value="~$285" />
  <MetricCard label="Current Price" value="~$195" change={-33} changeLabel="since halving" />
  <MetricCard label="Supply Minted" value="51.2%" />
</div>
...
<div class="not-prose my-6">
  <ComparisonTable
    title="Pre-Halving vs Post-Halving"
    headers={["Metric", "Pre-halving", "Post-halving (current)"]}
    rows={[
      { label: "TAO per block", values: ["1.0", "0.5"] },
      { label: "Daily emission", values: ["~7,200 TAO", "~3,600 TAO"] },
      { label: "Block time", values: ["~12 seconds", "~12 seconds"] },
      { label: "Annual inflation", values: ["~10%", "~5%"] },
      { label: "Circulating supply", values: ["~10.5M TAO", "~10.75M TAO"] },
      { label: "% of 21M cap minted", values: ["50%", "51.2%"] },
    ]}
  />
</div>
...
<div class="not-prose my-6">
  <ComparisonTable
    ...
    rows={[
      { label: "Total staked", values: ["~7.3M TAO"] },
      { label: "Staking ratio", values: ["~68% of circulating supply"] },
      { label: "Root (SN0) staking", values: ["~5.3M TAO (72% of staked)"] },
      { label: "Subnet (alpha) staking", values: ["~2.0M TAO (28% of staked)"] },
      { label: "Total accounts", values: ["~447,000"] },
    ]}
  />
  <DonutChart
    segments={[
      { label: "Root (SN0)", value: 72, color: "var(--color-accent)" },
      { label: "Subnet (Alpha)", value: 28, color: "var(--color-chart-3)" },
    ]}
    centerLabel="7.3M"
...
<div class="not-prose my-6">
  <ComparisonTable
    title="Halving Cycle Returns"
    headers={["Halving", "Date", "Price at halving", "Peak return", "Peak timing"]}
    rows={[
      { label: "Bitcoin 1st", values: ["Nov 2012", "~$12", "+8,858%", "12 months"] },
      { label: "Bitcoin 2nd", values: ["Jul 2016", "~$650", "+294%", "17 months"] },
      { label: "Bitcoin 3rd", values: ["May 2020", "~$8,500", "+541%", "18 months"] },
      { label: "Bitcoin 4th", values: ["Apr 2024", "~$64,000", "+25-40%", "Weakest cycle"] },
      { label: "TAO 1st", values: ["Dec 2025", "~$285", "-33% at 3 months", "TBD"] },
    ]}
  />
</div>
...
The Bittensor halving is real, verifiable, and permanent. Daily emissions are half of what they were. The supply dynamics are the cleanest in the DeAI space -- 21 million cap, no pre-mine, no VC allocation, algorithmic scarcity. For context on how Bittensor's competitive position fits the broader landscape, see [how DeAI actually competes](/why-deai/how-deai-actually-competes/).
