...
I do not hold FET. The governance breakdown that caused a founding member to leave within 18 months raises questions I have not been able to answer from public information. For individual project assessments, see our [Fetch/ASI review](/projects/fetch-asi/) and [Ocean review](/projects/ocean/). For how FET compares to other DeAI tokens on value capture, see [MOR vs TAO vs FET](/tokenomics/mor-vs-tao-vs-fet/).
...
<DonutChart
  segments={[
    { label: "AGIX migration", value: 32.95, color: "var(--color-accent)" },
    { label: "OCEAN migration", value: 23.22, color: "var(--color-chart-2)" },
    { label: "Founders", value: 8.77, color: "var(--color-chart-3)" },
    { label: "Foundation", value: 8.77, color: "var(--color-chart-4)" },
    { label: "Future releases", value: 7.63, color: "var(--color-chart-5)" },
    { label: "Mining/staking", value: 6.57, color: "var(--color-chart-6)" },
    { label: "Private sale", value: 5.08, color: "var(--color-chart-7)" },
    { label: "Advisors", value: 4.38, color: "#8B5CF6" },
    { label: "Public sale", value: 2.49, color: "#F97316" },
  ]}
  centerLabel="2.71B"
  centerSubLabel="Total FET"
  size={220}
/>
