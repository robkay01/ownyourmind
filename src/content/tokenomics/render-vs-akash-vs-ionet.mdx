...
<BarChart
  ...
  bars={[
    { label: "RENDER", value: 696, displayValue: "696x" },
    { label: "AKT", value: 32, displayValue: "32x" },
    { label: "IO (self-reported)", value: 1.9, displayValue: "~2x" },
  ]}
  unit="x"
/>
...
<ComparisonTable
  ...
  headers={["", "RENDER", "AKT (Akash)", "IO (io.net)"]}
  rows={[
    { label: "Market cap", values: ["$696M", "$100M", "~$34M"] },
    { label: "Revenue model", values: ["Burn-Mint Equilibrium (BME)", "Take fee on deployment spend", "Incentive Dynamic Engine (IDE)"] },
    { label: "2025 revenue", values: ["~$1M (burn-derived)", "$3.15M (on-chain verified)", "$20M+ annualised from Q1 2025 figures (self-reported)"] },
    { label: "Revenue verifiable?", values: ["Partially (burns on-chain, USD revenue not disclosed)", "Yes (Cosmos transactions, Messari reports)", "Partially (Messari quarterly reports, but core figures self-reported)"] },
    { label: "P/Revenue", values: ["~696x", "~32x", "~1.9x"] },
    { label: "Supply cap", values: ["644M (hard)", "No cap (8% inflation)", "800M (hard)"] },
    { label: "Network model", values: ["Permissioned", "Permissionless", "Permissionless portal"] },
    { label: "Core software", values: ["Proprietary (OTOY)", "Open source (Apache 2.0)", "Partially open"] },
    { label: "Freedom score", values: ["32/100 (F)", "66/100 (C)", "38/100 (F)"] },
    { label: "Returns score", values: ["72/100 (B)", "62/100 (C)", "54/100 (D)"] },
  ]}
/>
...
<StatCallout value="696x" label="RENDER P/Revenue ratio" sublabel="vs Akash at 32x -- the market pays a 20x premium for brand and liquidity" />

<BarChart
  title="2025 Revenue Comparison (USD)"
  bars={[
    { label: "RENDER", value: 1, displayValue: "~$1M (burn-derived)" },
    { label: "AKT", value: 3.15, displayValue: "$3.15M (on-chain)" },
    { label: "IO", value: 20, displayValue: "~$20M (self-reported)" },
  ]}
  unit="M"
/>
...
<ComparisonTable
  title="Revenue mechanism comparison"
  headers={["Mechanism", "RENDER", "AKT", "IO"]}
  rows={[
    { label: "Does revenue burn tokens?", values: ["Yes – 95% of job spend burned", "Not yet (BME approved, not active)", "Claimed – 50%+ of post-supplier revenue"] },
    { label: "Does revenue flow to holders?", values: ["Not to holders – no holder staking or fee distribution. Operators earn job-based rewards since RNP-019 (May 2025), tied to availability and completed work", "Partially – staking yields include small fee component", "Not clearly documented"] },
    { label: "Is revenue verifiable?", values: ["Partially – burns on-chain, USD not disclosed", "Yes – fully on-chain", "Partially – Messari reports, but core figures self-reported"] },
    { label: "Is the system deflationary?", values: ["Not yet (8x gap)", "Not yet (inflationary by design)", "Unknown"] },
    { label: "Revenue growth rate", values: ["+279% YoY burns (Render Foundation)", "+128% YoY spend", "N/A (too new)"] },
  ]}
/>
