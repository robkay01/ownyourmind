...
<div class="not-prose my-6">
  <AllocationBar allocations={[
    { category: "Subnet Owner", percentage: 18 },
    { category: "Miners", percentage: 41 },
    { category: "Validators & Stakers", percentage: 41 }
  ]} />
</div>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-3 not-prose my-6">
  <MetricCard label="Active Subnets" value="129" />
  <MetricCard label="TAO Price" value="~$195" />
  <MetricCard label="Circulating Supply" value="~9.6M TAO" />
  <MetricCard label="Max Supply" value="21M TAO" />
  <MetricCard label="Daily Emission" value="3,600 TAO (~$702k)" />
  <MetricCard label="Registration Cost" value="~746 TAO (~$145k)" />
  <MetricCard label="Block Time" value="12 seconds" />
  <MetricCard label="Tempo" value="~72 min (360 blocks)" />
</div>
...
<div class="not-prose my-6">
  <ComparisonTable
    title="Notable Subnets"
    headers={["ID", "Name", "What It Does"]}
    rows={[
      { label: "0", values: ["Root", "Subnet-agnostic TAO staking (special subnet, no miners)"] },
      { label: "1", values: ["Apex (Macrocosm OS)", "Open competitions for algorithmic and agentic optimisation"] },
      { label: "8", values: ["Vanta (Taoshi)", "Decentralised execution engine for prop trading"] },
      { label: "9", values: ["IOTA (Macrocosmos)", "Distributed AI model pretraining"] }
    ]}
  />
</div>
