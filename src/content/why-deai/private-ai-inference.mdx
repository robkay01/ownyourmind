...
<ComparisonTable
  ...
  rows={[
    ...
    { label: "Venice", values: ["1", "Policy (ZDR)", "Prompt content, not identity. Not stored by policy."] },
    { label: "Morpheus (current)", values: ["1→2", "Policy + P2P (TEE in dev)", "Prompt during inference. TEE shipping."] },
    { label: "Phala Network", values: ["2", "TEE (hardware)", "Nothing — hardware enclave prevents access"] },
    { label: "Oasis (ROFL)", values: ["2", "TEE (hardware)", "Nothing during computation"] },
    { label: "Arcium", values: ["3", "MPC+FHE+ZKP", "Fragments only — no party sees complete data"] },
    { label: "Nillion", values: ["3", "MPC + secret sharing", "Fragments only"] },
    { label: "Local (Ollama, llama.cpp)", values: ["4", "Physical isolation", "No provider exists"] },
  ]}
/>
