...
<ComparisonTable
  ...
  headers={["Project", "Level", "Privacy type", "What the provider sees"]}
  rows={[
    { label: "OpenAI / Anthropic", values: ["Level 0", "None", "Everything: identity + prompt + stored"] },
    { label: "Venice", values: ["Level 1", "Policy (ZDR)", "Prompt content, not identity. Not stored by policy."] },
    { label: "Morpheus (current)", values: ["Level 1→2", "Policy + P2P (TEE in dev)", "Prompt during inference. TEE shipping."] },
    { label: "Phala Network", values: ["Level 2", "TEE (hardware)", "Nothing — hardware enclave prevents access"] },
    { label: "Oasis (ROFL)", values: ["Level 2", "TEE (hardware)", "Nothing during computation"] },
    { label: "Arcium", values: ["Level 3", "MPC+FHE+ZKP", "Fragments only — no party sees complete data"] },
    { label: "Nillion", values: ["Level 3", "MPC + secret sharing", "Fragments only"] },
    { label: "Local (Ollama, llama.cpp)", values: ["Level 4", "Physical isolation", "No provider exists"] },
  ]}
/>
