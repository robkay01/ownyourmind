...
<ComparisonTable
  ...
  rows={[
    { label: "OpenAI / Anthropic", values: [0, "None", "Everything: identity + prompt + stored"] },
    { label: "Venice", values: [25, "Policy (ZDR)", "Prompt content, not identity. Not stored by policy."] },
    { label: "Morpheus (current)", values: [37, "Policy + P2P (TEE in dev)", "Prompt during inference. TEE shipping."] },
    { label: "Phala Network", values: [50, "TEE (hardware)", "Nothing — hardware enclave prevents access"] },
    { label: "Oasis (ROFL)", values: [50, "TEE (hardware)", "Nothing during computation"] },
    { label: "Arcium", values: [75, "MPC+FHE+ZKP", "Fragments only — no party sees complete data"] },
    { label: "Nillion", values: [75, "MPC + secret sharing", "Fragments only"] },
    { label: "Local (Ollama, llama.cpp)", values: [100, "Physical isolation", "No provider exists"] },
  ]}
/>
