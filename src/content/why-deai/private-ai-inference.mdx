...
draft: false
podcastUrl: "/podcast/Own-Your-Mind--WhyDeaiPrivateAiInference.mp3"
---
...
<SpectrumBar
  title="The AI Privacy Spectrum"
  leftLabel="No privacy"
  rightLabel="Full isolation"
  markers={[
    { position: 0, label: "OpenAI/Anthropic", sublabel: "Level 0" },
    { position: 25, label: "Venice", sublabel: "Level 1" },
    { position: 50, label: "Phala/Oasis", sublabel: "Level 2" },
    { position: 75, label: "Arcium/Nillion", sublabel: "Level 3" },
    { position: 100, label: "Local", sublabel: "Level 4" },
  ]}
  colorFrom="#EF4444"
  colorTo="#10B981"
/>
...
<FlowDiagram
  title="Venice privacy flow (Level 1)"
  steps={[
    { label: "Your prompt", icon: "📝" },
    { label: "Venice proxy", sublabel: "Identity stripped", icon: "🔀" },
    { label: "GPU provider", sublabel: "Sees prompt, not identity", icon: "⚡" },
    { label: "Response", sublabel: "Data purged", icon: "✅" },
  ]}
/>
...
<FlowDiagram
  title="TEE privacy flow (Level 2)"
  steps={[
    { label: "Your prompt", icon: "📝" },
    { label: "TEE enclave", sublabel: "Hardware-encrypted", icon: "🔒" },
    { label: "GPU processes", sublabel: "Cannot read contents", icon: "⚡" },
    { label: "Response", sublabel: "Attestation verified", icon: "✅" },
  ]}
/>
...
<ComparisonTable
  title="Where each project sits on the privacy spectrum"
  headers={["Project", "Privacy level", "Privacy type", "What the provider sees"]}
  rows={[
    { label: "OpenAI / Anthropic", values: ["L0", "None", "Everything: identity + prompt + stored"] },
    { label: "Venice", values: ["L1", "Policy (ZDR)", "Prompt content, not identity. Not stored by policy."] },
    { label: "Morpheus (current)", values: ["L1→2", "Policy + P2P (TEE in dev)", "Prompt during inference. TEE shipping."] },
    { label: "Phala Network", values: ["L2", "TEE (hardware)", "Nothing. Hardware enclave prevents access"] },
    { label: "Oasis (ROFL)", values: ["L2", "TEE (hardware)", "Nothing during computation"] },
    { label: "Arcium", values: ["L3", "MPC+FHE+ZKP", "Fragments only. No party sees complete data"] },
    { label: "Nillion", values: ["L3", "MPC + secret sharing", "Fragments only"] },
    { label: "Local (Ollama, llama.cpp)", values: ["L4", "Physical isolation", "No provider exists"] },
  ]}
/>
...
<StatCallout value="10+ PRs" label="Merged to dev branch in 5 days" sublabel="SCRT Labs partnership, Intel TDX" />
...
The projects that win the infrastructure battle will be the ones that push up the privacy level while keeping the cost and performance competitive. Venice claims that Level 1 has attracted 1.3 million users. Phala is proving that Level 2 is production-viable. The gap between "works in a paper" and "works at scale" for Levels 3 and beyond is closing.
