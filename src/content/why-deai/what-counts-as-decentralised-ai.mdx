...
**DeAI-adjacent** projects like [Akash](/projects/akash/) (general-purpose compute), [Render](/projects/render/) (GPU rendering expanded to inference), Phala (confidential computing pivoting to AI agents) and Nillion (blind computation with AI inference as one application) have real technology serving AI workloads, but the protocol is general-purpose.
