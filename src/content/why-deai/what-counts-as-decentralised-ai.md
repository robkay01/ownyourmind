...
description: "Every crypto project is an AI project now. Most of them are lying. Three tests for separating genuine DeAI from narrative-surfing."
...
CoinMarketCap's AI category includes [Bittensor](/projects/bittensor/) (a network designed from the ground up to incentivise machine learning), [NEAR Protocol](/projects/near/) (a sharded L1 that rebranded as "The Blockchain for AI"), and Injective (a DeFi chain with no AI product at all). [Messari's classification system](https://messari.io/sectors) includes "AI Meme" as a legitimate sub-sector alongside AI Infrastructure. That tells you everything.
...
**Examples:** [Bittensor](/projects/bittensor/), [Gensyn](/projects/gensyn/), [Venice](/projects/venice/), [io.net](/projects/io-net/), [Morpheus](/projects/morpheus/), [Grass](/projects/grass/), [Ocean Protocol](/projects/ocean/), [Vana](/projects/vana/)
...
**Examples:** [Akash](/projects/akash/) (general-purpose compute), [Render](/projects/render/) (GPU rendering expanded to inference), Phala (confidential computing pivoting to AI agents), Nillion (blind computation with AI inference as one application)
