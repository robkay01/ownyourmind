...
[Venice](/projects/venice/), the privacy-focused inference platform, has grown to 1.3 million registered users and processes 45 billion tokens daily. That is not traffic funnelled through a single provider. That is inference demand from users who explicitly chose not to send their prompts to OpenAI. The signal is clear.
