...
draft: false
podcastUrl: "/podcast/Own-Your-Mind--WhyDeaiSovereignAi.mp3"
---
...
<StatCallout value="60-85%" label="cheaper compute on decentralised networks vs AWS" sublabel="Sovereignty does not have to mean paying more" />
...
<ComparisonTable
  title="Sovereign AI vs centralised AI"
  headers={["", "Centralised AI", "Sovereign AI"]}
  rows={[
    { label: "Who controls the model", values: ["The provider. They choose which models to offer, what they refuse, and when to deprecate.", "You do. Open-weight models you can run, modify, and host anywhere."] },
    { label: "Where your data goes", values: ["Provider servers. OpenAI trains on conversations by default. Google feeds data into its advertising infrastructure.", "Nowhere you do not choose. Local inference means prompts never leave your machine."] },
    { label: "Content restrictions", values: ["Corporate content policies. GPT refuses security research. Claude declines certain creative writing.", "None beyond what you impose. Open models have no content filter. You decide the boundaries."] },
    { label: "Pricing and access", values: ["The provider sets prices and can change them overnight. Models deprecated without notice.", "You own the hardware or pay market rates on decentralised compute. Akash claims 60-85% below AWS."] },
    { label: "Uptime guarantee", values: ["Dependent on one company. When OpenAI goes down, every app using their API goes down.", "Distributed across independent providers. No single point of failure at sufficient scale."] },
    { label: "Lock-in risk", values: ["High. Fine-tunes, history, integrations all tied to one platform.", "Low. Open models are portable. Your fine-tunes, your weights, your data. Move freely."] },
  ]}
/>
...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-3 my-4">
  <MetricCard value="~$3,000" label="Mac Studio M4 Max" changeLabel="one-time, runs 70B models locally" />
  <MetricCard value="$18/mo" label="Venice Pro" changeLabel="unlimited private inference" />
  <MetricCard value="$0" label="Venice Free Tier" changeLabel="10 prompts/day, no account" />
  <MetricCard value="60-85%" label="Akash savings" changeLabel="vs AWS equivalent GPU compute" />
</div>
