---
title: "The Quadrant Model"
description: "How we position DeAI projects on two axes: Freedom Score and Returns Score. Four quadrants, what each means, and why both dimensions matter."
publishDate: 2026-03-08
draft: false
---

Every project we review gets two independent scores: a [Freedom Score](/resources/freedom-score-methodology/) measuring decentralisation, and a [Returns Score](/resources/returns-score-methodology/) measuring token value capture. The quadrant model plots these against each other.
...
**Returns Score (0–100)** measures how well the token captures value. Five dimensions: token utility, value accrual, supply dynamics, revenue sustainability, and liquidity.
